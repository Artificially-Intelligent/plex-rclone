...
if ! [ -z "${RCLONE_DRIVE_TEAM_DRIVE}" ]; then
    PLEXDRIVE_TEAM_DRIVE_OPTIONS=" --drive-id=$RCLONE_DRIVE_TEAM_DRIVE "
    echo "note: RCLONE_DRIVE_TEAM_DRIVE env variable defined. Adding $PLEXDRIVE_TEAM_DRIVE_OPTIONS to plexdrive options"
fi
